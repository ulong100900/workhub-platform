...
export default function ProjectsPage() {
  ...
  const fetchProjects = async () => {
    try {
      ...
      if (result.success && Array.isArray(result.data)) {
        ...
        setTotalProjects(result.pagination?.total || result.data.length)
      } else {
        setProjects([])
        setTotalProjects(0)
      }
  ...
  useEffect(() => {
    fetchProjects()
  }, [selectedCategory, selectedSubcategory, selectedCity, searchQuery])
  ...
  // Фильтрация проектов (на клиенте для быстрого поиска)
              ...
              {showCityDropdown && (
                <div className="absolute top-full right-0 mt-2 z-50 bg-white rounded-xl shadow-2xl border overflow-hidden">
                  ...
                  <div className="flex max-h-[450px]">
                    ...
                    {/* Города в регионе - ШИРОКАЯ КОЛОНКА */}
